...
import 'package:fakerecruit/screen_item/recruit_selected_item.dart';
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: GestureDetector(
        // GestureDetectorでContainerを囲う(画面遷移用)
        onTap: () {
            Navigator.of(context).push(
            MaterialPageRoute(
              builder: ((context) => RecruitSelectedItem(recruitInfo: recruitInfo)),
            ),
          );
        },
        child: Container(
